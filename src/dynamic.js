 ...
 * @apiSuccess {String}     obj.user              动态发表人
 * @apiSuccess {String}     obj.user.id              动态发表人ID
 * @apiSuccess {String}     obj.user.nickname            动态发表人昵称
 * @apiSuccess {String}     obj.user.photo               动态发表人头像
 * @apiSuccess {Date}       obj.createTime          动态发表时间
 * @apiSuccess {Number}     obj.type                动态类型
 * @apiSuccess {Object[]}   obj.praises       动态点赞信息
 * @apiSuccess {String}     obj.praises.user                   点赞用户
 * @apiSuccess {String}     obj.praises.user.id                点赞用户的ID
 * @apiSuccess {String}     obj.praises.user.nickname          点赞用户的昵称
 * @apiSuccess {String}     obj.praises.user.photo             点赞用户的头像
 * @apiSuccess {Object[]}   obj.comments                      动态评论
 * @apiSuccess {String}     obj.comments.id                   评论ID
 * @apiSuccess {String}     obj.comments.dynamicId            动态ID
 * @apiSuccess {String}     obj.comments.user                 评论人
 * @apiSuccess {String}     obj.comments.user.id              评论人ID
 * @apiSuccess {String}     obj.comments.user.nickname        评论人昵称
 * @apiSuccess {String}     obj.comments.atUser               @用户
 * @apiSuccess {String}     obj.comments.atUser.nickname      评论人昵称
 * @apiSuccess {String}     obj.comments.content              评论内容
 * @apiSuccess {Date}       obj.comments.createTime           评论时间
