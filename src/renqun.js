/**
 * @api {get} /RenqunApi/getRenqunList 获取收藏列表
 * @apiVersion 2.0.0
 * @apiName getRenqunList
 * @apiGroup Renqun
 * @apiPermission login
 *
 ...
 *     }
 */
function getMyRenqunList() { return; }

/**
 * @api {get} /RenqunApi/deleteRenqun 删除收藏
 * @apiVersion 2.0.0
 * @apiName deleteRenqun
 * @apiGroup Renqun
 * @apiPermission login
 *
